 ...
 * 3. 注册字符设备 /dev/system_insight_cpu_stat，通过 mmap 暴露给用户空间
 */
...
#define DEVICE_NAME "system_insight_cpu_stat"
#define CLASS_NAME  "system_insight_cpu_stat"
#define MAX_CPUS    256

MODULE_LICENSE("GPL");
MODULE_AUTHOR("System Insight");
